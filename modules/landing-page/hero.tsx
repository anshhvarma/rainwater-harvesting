      ...
      <div className="relative z-10 container mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-white/60 md:text-xl">
            Assess rooftop area, rainwater harvesting potential, and artificial
            recharge capacity in real-time using our intuitive tool – no prior
            expertise required.
          </p>
